    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#0a0a0a]">
            <div class="w-full max-w-md fade-in">
                ...
                <div class="mb-8">
                    <h2 class="text-3xl font-light text-white mb-2">Create Account</h2>
                    <p class="text-white/50">Join our exclusive community today</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <!-- Confirm Password -->
                    <div class="mb-6">
                        <label for="password_confirmation" class="block text-sm font-medium text-white/70 mb-2">Confirm
                            Password</label>
                    ...
                    <!-- Submit Button -->
                    <button type="submit"
                        class="btn-gold w-full py-3 px-6 rounded-lg text-black font-semibold tracking-wide transition-all duration-300">CREATE
                        ACCOUNT</button>
                </form>
                ...
                <div class="mt-8 text-center">
                    <p class="text-white/50">
                        ...
                        <a href="{{ route('login') }}" class="link-gold font-medium hover:underline">Sign In</a>
                    </p>
                </div>
            </div>
        </div>
