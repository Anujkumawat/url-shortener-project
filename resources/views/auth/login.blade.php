    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-[#0a0a0a]">
            <div class="w-full max-w-md fade-in">
                ...
                <div class="mb-8">
                    <h2 class="text-3xl font-light text-white mb-2">Welcome Back</h2>
                    <p class="text-white/50">Enter your credentials to access your account</p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        <label for="remember_me" class="inline-flex items-center">
                            <input id="remember_me" type="checkbox"
                                class="rounded border-white/20 bg-white/5 text-yellow-500 focus:ring-yellow-500/50"
                                name="remember">
                            <span class="ml-2 text-sm text-white/50">Remember me</span>
                        </label>

                        @if (Route::has('password.request'))
                        <a class="text-sm link-gold hover:underline" href="{{ route('password.request') }}">Forgot
                            password?</a>
                        @endif
                    </div>
                    ...
                    <!-- Submit Button -->
                    <button type="submit"
                        class="btn-gold w-full py-3 px-6 rounded-lg text-black font-semibold tracking-wide transition-all duration-300">SIGN
                        IN</button>
                </form>
                ...
                <div class="mt-8 text-center">
                    <p class="text-white/50">
                        ...
                        <a href="{{ route('register') }}" class="link-gold font-medium hover:underline">Create
                            Account</a>
                        @endif
                    </p>
                </div>
